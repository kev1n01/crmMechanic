                ...
                <div class="card-body">
                    <x-form method="save">
                        <div class="row mb-4 justify-content-center ">
                            <x-input.input-tooltip-error class="col-xl-2 me-1" name="editing.code_purchase"
                                label="Código" type="text" :error="$errors->first('editing.code_purchase')" :required=true />

                            <x-input.select class="col-xl-2 me-1" name="editing.provider_id" label="Proveedor"
                            ...
                            <x-input.input-tooltip-error class="col-xl-2 me-1" name="editing.date_purchase"
                                label="Fecha de compra" type="date" :error="$errors->first('editing.date_purchase')" :required=true />
                        ...
                        <div class="row m-1">
                            <div class="app-search dropdown d-lg-block mb-3">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg w-75 {{ $products ? 'd-block' : '' }}">
