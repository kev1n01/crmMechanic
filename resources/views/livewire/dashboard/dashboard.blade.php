            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        <h5 class="text-muted fw-normal mt-0 text-truncate" title="Campaign Sent">Clientes</h5>
                        <h3 class="my-2 py-1">{{ $customers }}</h3>
                        <p class="mb-0">
                            <a class="text-success me-2" href="{{ route('clientes') }}">ver</a>
                        </p>
                    </div> <!-- end row-->
                </div> <!-- end card-body -->
            </div> <!-- end card -->
