                    ...
                    <div class="row mb-2">
                        ...
                        <div class="row col-xl-5">
                            <div class="text-xl-end mt-xl-0 mt-2">
                                ...
                                <button type="button" wire:click="$emit('createtype')" class="btn btn-dark mb-2 me-2"><i
                        ...
                        <x-table>
                            ...
                            <x-slot name="body">
                                @forelse ($types as $type)
                                    <x-table.row wire:key="row-{{ $type->id }}" wire:loading.class="bg-light"
                                        wire:target="search">
                                        <x-table.cell>
                                            <x-input.check-input name="selected" value="{{ $type->id }}" />
                                        </x-table.cell>
                                        <x-table.cell>{{ $type->id }}</x-table.cell>

                                        <x-table.cell>{{ $type->name }}</x-table.cell>

                                        <x-table.cell>{{ \Carbon\Carbon::parse($type->created_at)->format('d-m-Y') }}
                                        </x-table.cell>
