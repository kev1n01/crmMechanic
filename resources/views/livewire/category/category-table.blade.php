                    ...
                    <div class="row mb-2">
                        ...
                        <div class="row col-xl-5">
                            <div class="text-xl-end mt-xl-0 mt-2">
                                ...
                                <button title="Crear categoría" type="button" wire:click="$emit('createcategory')"
                        ...
                        <x-table>
                            ...
                            <x-slot name="body">
                                @forelse ($categories as $category)
                                    <x-table.row wire:key="row-{{ $category->id }}" wire:loading.class="bg-light"
                                        wire:target="search">
                                        <x-table.cell>
                                            <x-input.check-input name="selected" value="{{ $category->id }}" />
                                        </x-table.cell>
                                        ...
                                        <x-table.cell>
                                            ...
                                            onclick="Confirm({{ $category->id }}, 'delete')">
                                            Eliminar</a>
                                        </x-table.cell>
                                    </x-table.row>
                                @empty
