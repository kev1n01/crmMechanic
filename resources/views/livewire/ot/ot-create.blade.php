                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2 justify-content-center ">
                            <x-input.input-tooltip-error class="col-xl-2 me-1" name="editing.code" label="Código"
                            ...
                            <x-input.select class="col-xl-2 me-1 mb-2" name="editing.status" label="Estado"
                                :required=true :options="$statuses" :error="$errors->first('editing.status')" />

                            <x-input.select class="col-xl-2 me-1 mb-2" name="editing.vehicle" label="Vehiculo"
                                :required=true :options="$vehicles" :error="$errors->first('editing.vehicle')" />

                            <x-input.input-tooltip-error class="col-xl-2 me-1 mb-2" name="editing.odo" label="ODO"
                            ...
                            <x-input.select class="col-xl-3 me-1 mb-2" name="editing.sale" label="Venta"
                                :options="$sales" :error="$errors->first('editing.sale')" />
                            ...
                            <div class="app-search dropdown d-lg-block mb-3">
                                <div class="input-group w-auto">
                                    <input type="search" class="form-control me-2"
                                        placeholder="Buscar servicios y repuestos..." wire:model="searchConcept"
                                    ...
                                    <button type="button" wire:click="clearCart" class="btn border border-secondary"
                                        {{ !$editing->customerd || !$editing->vehicle ? 'disabled' : '' }}><i
                                            class="mdi mdi-reload"></i></button>
                                </div>

                                <div
                                    class="dropdown-menu dropdown-menu-animated dropdown-lg w-75 {{ $concepts ? 'd-block' : '' }}">
                                    ...
                                    @empty
                                        <a class="dropdown-item notify-item">
                                            <span>No se encontro este servicio</span>
                                        </a>
                                    @endif
                                </div>
                            </div>
                                        ...
                                        <x-table.row>
                                            ...
                                            <x-table.cell>
                                                <input type="text" id="p{{ $c->id }}"
                                                    ...
                                                    value="{{ number_format($c->price, 2) }}"
                                                    {{ strlen($c->id) === 5 ? 'disabled' : '' }}>
                                            </x-table.cell>
                                            <x-table.cell>
