@section('title', 'Editar orden de trabajo ' . $editing->code)
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <x-input.select-button class="col-xl-8 pe-0" name="editing.vehicle" label="Vehiculo"
                                        :options="$vehicles" :error="$errors->first('editing.vehicle')" :required=true
