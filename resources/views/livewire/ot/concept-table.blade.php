                    ...
                    <div class="row mb-2">
                        ...
                        <div class="row col-xl-5">
                            <div class="text-xl-end mt-xl-0 mt-2">
                                ...
                                <button type="button" wire:click="$emit('createconcept')" class="btn btn-dark mb-2 me-2"><i
                        ...
                        <x-table>
                            ...
                            <x-slot name="body">
                                @forelse ($concepts as $concept)
                                    <x-table.row wire:key="row-{{ $concept->id }}" wire:loading.class="bg-light"
                                        wire:target="search">
                                        <x-table.cell>
                                            <x-input.check-input name="selected" value="{{ $concept->id }}" />
                                        </x-table.cell>
                                        ...
                                        <x-table.cell>
                                            ...
                                            wire:click="$emit('editconcept',{{ $concept->id }})">
                                            Editar</a>
                                           
                                            <a class="btn btn-danger btn-sm mb-1"
                                            onclick="Confirm({{ $concept->id }}, 'delete')">
                                            Eliminar</a>
                                        </x-table.cell>
