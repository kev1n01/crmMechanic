                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="card">
                            <div class="row g-2 p-2">
                                <x-input.input-tooltip-error class="col-xl-4 mt-2" name="editing.code" label="Código"
                                    type="text" :error="$errors->first('editing.code')" :required=true :disabled=true />

                                <x-input.select class="col-xl-4 mt-2" name="editing.type_atention" label="Tipo de atención"
                                    :options="$types" :error="$errors->first('editing.type_atention')" :required=true />

                                <x-input.datepicker class="col-xl-4 mt-2" name="editing.date_emission" label="Fecha emision"
                                    id="dp1" :error="$errors->first('editing.date_emission')" :required=true />

                                <x-input.textarea class="col-xl-12 mt-2" name="editing.observation" label="Observaciones"
                                    rows="4" />
                            </div>
                        </div>
                    </div>
                                ...
                                <div id="scroll-products"
                                    ...
                                    @forelse ($concepts as $c)
                                        <span class="dropdown-item notify-item"
                                            ...
                                            <span>⚒️ {{ $c->name . ' - codigo: ' . $c->code . ' - price: ' . $c->price }}</span>
                                        </span>
                                    @empty
                                    ...
                                    @forelse ($products as $p)
                                        <span class="dropdown-item notify-item"
                                            ...
                                            <span>📦
                                                {{ $p->name . ' - codigo: ' . $p->code . ' - stock: ' . $p->stock . ' - estado: ' . $p->status . ' - precio venta: ' . $p->sale_price . ' - precio compra: ' . $p->purchase_price }}</span>
                                        </span>
                                    @empty
                                        <a class="dropdown-item notify-item">
